...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { article_id: @block.article_id, btext: @block.btext, num: @block.num } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { article_id: @block.article_id, btext: @block.btext, num: @block.num } }
